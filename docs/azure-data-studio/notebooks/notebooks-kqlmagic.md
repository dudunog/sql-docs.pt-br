...
- [Extensão do Kusto (KQL) para o Azure Data Studio (versão prévia)](../extensions/kusto-extension.md)
- [Criar e executar um notebook do Kusto (KQL) (versão prévia)](./notebooks-kusto-kernel.md)
