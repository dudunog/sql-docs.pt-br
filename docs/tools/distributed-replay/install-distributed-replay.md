...
description: 'Este artigo descreve as maneiras de instalar o Distributed Replay: usando o Assistente de Instalação, a janela do Prompt de Comando ou um arquivo de configuração.'
ms.prod: sql
ms.reviewer: ''
...
##  <a name="install-distributed-replay-from-the-installation-wizard"></a><a name="bkmk_wizard"></a> Instalar o Distributed Replay por meio do Assistente de Instalação  
...
-   Em um sistema de 32 bits:  
     ...
     \<Share Feature Directory>\Tools\\(diretório de recursos compartilhados alternativos fornecidos pelo usuário)  
...
-   Em um sistema de 64 bits:  
     ...
     \<Share Feature Directory (x86)>\Tools\\(diretório de recursos compartilhados alternativos (x86) fornecidos pelo usuário)  
...
##  <a name="install-distributed-replay-from-the-command-prompt"></a><a name="bkmk_command_prompt"></a> Instalar o Distributed Replay a partir do prompt de comando  
...
##  <a name="install-distributed-replay-using-a-configuration-file"></a><a name="bkmk_configuration_file"></a> Instalar o Distributed Replay usando um arquivo de configuração  
...
-   Os valores da linha de comando substituem os valores do arquivo de configuração  
 ...
 Para obter mais informações sobre como usar um arquivo de configuração, veja [Instalar o SQL Server 2016 usando um arquivo de configuração](../../database-engine/install-windows/install-sql-server-using-a-configuration-file.md).  
