---
title: Derivar um modelo de um rastreamento em execução
titleSuffix: SQL Server Profiler
description: Saiba como criar um modelo com base em um rastreamento existente no SQL Server Profiler enquanto o rastreamento está em execução.
ms.prod: sql
