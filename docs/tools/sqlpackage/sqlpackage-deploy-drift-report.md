---
title: Relatórios de implantação e descompasso do SqlPackage
description: Saiba como automatizar tarefas de desenvolvimento de banco de dados com os relatórios de implantação e descompasso do SqlPackage.exe. Veja exemplos e parâmetros, propriedades e variáveis SQLCMD disponíveis.
ms.prod: sql
...
ms.locfileid: "97577783"
---
# <a name="sqlpackage-deploy-report-and-drift-report"></a>Relatórios de implantação e descompasso do SqlPackage
A ação [DeployReport](#deployreport-action-parameters) do SqlPackage.exe cria um relatório XML das alterações que seriam feitas por uma ação de publicação.
A ação [DriftReport](#driftreport-action-parameters) do SqlPackage.exe cria um relatório XML das alterações que foram feitas em um banco de dados registrado desde o último registro.  
...
## <a name="deployreport-action-parameters"></a>Parâmetros da ação DeployReport
...
## <a name="deployreport-action-properties"></a>Propriedades da ação DeployReport
...
## <a name="driftreport-action-parameters"></a>Parâmetros da ação DriftReport
