---
title: Publicação do SqlPackage
description: Saiba como automatizar tarefas de desenvolvimento de banco de dados com a ação Publish do SqlPackage.exe. Veja exemplos e parâmetros, propriedades e variáveis SQLCMD disponíveis.
ms.prod: sql
...
## <a name="parameters-for-the-publish-action"></a>Parâmetros da ação Publish
