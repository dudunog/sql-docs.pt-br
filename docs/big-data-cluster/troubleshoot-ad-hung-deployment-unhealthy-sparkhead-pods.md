...
description: Solução de problemas de implantação sem resposta de um cluster de Big Data do SQL Server em um domínio do Active Directory com pods `sparkhead` não íntegros.
author: macarv-ms
ms.author: macarv
ms.reviewer: mikeray
ms.date: 08/20/2020
...
## <a name="check-the-hdfs-and-spark-services"></a>Verificar os serviços HDFS e Spark 
...
:::image type="content" source="media/troubleshoot-ad-hung-deployment-unhealthy-sparkhead-pods/missing_reverse_lookup_zone_entry_for_domain_controller_add.png" alt-text="Adicionar a entrada da zona de pesquisa inversa ausente para o controlador de domínio":::
