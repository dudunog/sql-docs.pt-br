...
É possível usar o [Azure Data Studio](../azure-data-studio/what-is-azure-data-studio.md) para executar uma variedade de tarefas no cluster de Big Data:
