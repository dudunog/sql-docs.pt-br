...
description: Force um nó de cluster de clustering de failover do Windows Server a iniciar sem um quorum, o que pode ser necessário para recuperar dados e restabelecer a alta disponibilidade.
