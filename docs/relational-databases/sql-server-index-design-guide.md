...
```  
 ...
 ![Diagrama de um plano de execução dessa consulta que mostra que o otimizador de consultas usou um operador SORT para retornar o conjunto de resultados na ordem especificada pela cláusula ORDER BY.](../relational-databases/media/indexsort1.gif)
...
```  
 ...
 ![Diagrama de um plano de execução que mostra que o operador SORT foi eliminado e que o índice não clusterizado recém-criado foi utilizado.](../relational-databases/media/insertsort2.gif)
...
### <a name="clustered-index-architecture"></a>Arquitetura de índice clusterizado  
 ...
 ![Diagrama que mostra a estrutura de um índice clusterizado em uma partição única.](../relational-databases/media/bokind2.gif)  
...
![Diagrama que mostra a estrutura de um índice não clusterizado em uma partição única.](../relational-databases/media/bokind1a.gif)  
...
[Melhorando o desempenho com exibições indexadas do SQL Server 2008](/previous-versions/sql/sql-server-2008/dd171921(v=sql.100))  
