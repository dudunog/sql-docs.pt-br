...
## <a name="remarks"></a>Comentários  
 ...
 Use **Sys.dm_exec_query_resource_semaphores** para solução de problemas, mas não a inclua em aplicativos que usarão versões futuras do [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] .  
