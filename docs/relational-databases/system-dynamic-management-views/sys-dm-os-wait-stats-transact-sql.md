...
|tipo |Descrição| 
|-------------------------- |--------------------------| 
|ABR |Identificado apenas para fins informativos. Não há suporte. A compatibilidade futura não está garantida.| | 
|AM_INDBUILD_ALLOCATION |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|AM_SCHEMAMGR_UNSHARED_CACHE |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|ASSEMBLY_FILTER_HASHTABLE |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
...
|ASYNC_OP_COMPLETION |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] e posterior.| 
|ASYNC_OP_CONTEXT_READ |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] e posterior.| 
|ASYNC_OP_CONTEXT_WRITE |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] e posterior.| 
|ASYNC_SOCKETDUP_IO |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
...
|BLOB_METADATA |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
...
|BROKER_START |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
...
|CHECK_SCANNER_MUTEX |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|CHECK_TABLES_INITIALIZATION |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|CHECK_TABLES_SINGLE_SCAN |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|CHECK_TABLES_THREAD_BARRIER |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
...
|COLUMNSTORE_COLUMNDATASET_SESSION_LIST |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|COMMIT_TABLE |Somente para uso interno.| 
|CONNECTION_ENDPOINT_LOCK |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
...
|DIRECTLOGCONSUMER_LIST |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
...
|DIRTY_PAGE_TABLE_LOCK |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
...
|DPT_ENTRY_LOCK |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
...
|DTCNEW_ENLIST |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|DTCNEW_PREPARE |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|DTCNEW_RECOVERY |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|DTCNEW_TM |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|DTCNEW_TRANSACTION_ENLISTMENT |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
...
|EXTERNAL_RG_UPDATE |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
...
|EXTERNAL_SCRIPT_PREPARE_SERVICE |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|EXTERNAL_SCRIPT_SHUTDOWN |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|EXTERNAL_WAIT_ON_LAUNCHER, |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
...
|FILE_VALIDATION_THREADS |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
...
|FORWARDER_TRANSITION |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
...
|GLOBAL_QUERY_CLOSE |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
...
|GLOBAL_TRAN_CREATE |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|GLOBAL_TRAN_UCS_SESSION |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
...
|HADR_DATABASE_WAIT_FOR_RECOVERY |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
...
|HADR_FILESTREAM_IOMGR |O Gerenciador de transporte de Always On FILESTREAM está aguardando um bloqueio de R/W que protege o FILESTREAM Always On o Gerenciador de e/s durante a inicialização ou O desligamento. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
...
|HADR_FILESTREAM_PREPROC |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
...
|HADR_SEEDING_CANCELLATION |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|HADR_SEEDING_FILE_LIST |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|HADR_SEEDING_LIMIT_BACKUPS |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|HADR_SEEDING_SYNC_COMPLETION |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|HADR_SEEDING_TIMEOUT_TASK |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|HADR_SEEDING_WAIT_FOR_COMPLETION |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
...
|HADR_THROTTLE_LOG_RATE_GOVERNOR |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
...
|HCCO_CACHE |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|HK_RESTORE_FILEMAP |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|HKCS_PARALLEL_MIGRATION |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|HKCS_PARALLEL_RECOVERY |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
...
|INSTANCE_LOG_RATE_GOVERNOR |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
...
|IO_QUEUE_LIMIT |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
...
|LOG_POOL_SCAN |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|LOG_RATE_GOVERNOR |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
...
|LOGMGR_PMM_LOG |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
...
|LOGPOOL_CACHESIZE |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|LOGPOOL_CONSUMER |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|LOGPOOL_CONSUMERSET |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|LOGPOOL_FREEPOOLS |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|LOGPOOL_MGRSET |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|LOGPOOL_REPLACEMENTSET |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|LOGPOOLREFCOUNTEDOBJECT_REFDONE |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|LOWFAIL_MEMMGR_QUEUE |Ocorre ao aguardar que a memória esteja disponível para uso.| 
|MD_AGENT_YIELD |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|MD_LAZYCACHE_RWLOCK |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|MEMORY_ALLOCATION_EXT |Ocorre ao alocar memória do pool de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] memória interna ou do sistema operacional. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|MEMORY_GRANT_UPDATE |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] e posterior.| 
|METADATA_LAZYCACHE_RWLOCK |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssKilimanjaro_md](../../includes/sskilimanjaro-md.md)] somente. |  
|MIGRATIONBUFFER |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] e posterior.| 
...
|NETWORKSXMLMGRLOAD |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|NODE_CACHE_MUTEX |Somente para uso interno.| 
|OLEDB |Ocorre quando [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] chama o provedor de OLE DB de SNAC (sqlncli) ou o Microsoft OLE DB driver for SQL Server (MSOLEDBSQL). Esse tipo de espera não é usado para sincronização. Em vez disso, ele indica a duração de chamadas ao provedor OLE DB.| 
...
|PAGELATCH_NL |Identificado apenas para fins informativos. Não há suporte. A compatibilidade futura não está garantida.| 
...
|PARALLEL_REDO_DRAIN_WORKER |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|PARALLEL_REDO_FLOW_CONTROL |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|PARALLEL_REDO_LOG_CACHE |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|PARALLEL_REDO_TRAN_LIST |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|PARALLEL_REDO_TRAN_TURN |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|PARALLEL_REDO_WORKER_SYNC |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|PARALLEL_REDO_WORKER_WAIT_WORK |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|PERFORMANCE_COUNTERS_RWLOCK |Somente para uso interno.| 
|PHYSICAL_SEEDING_DMV |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] e posterior.| 
|POOL_LOG_RATE_GOVERNOR |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|PREEMPTIVE_ABR |Identificado apenas para fins informativos. Não há suporte. A compatibilidade futura não está garantida.| 
|PREEMPTIVE_AUDIT_ACCESS_EVENTLOG |Ocorre quando o agendador de Sistema operacional (SQLOS) [!INCLUDE[ssNoVersion_md](../../includes/ssnoversion-md.md)] alterna para o modo preemptivo para gravar um evento de auditoria para o log de eventos do Windows. <br /><br /> **Aplica-se a**: [!INCLUDE[ssKilimanjaro_md](../../includes/sskilimanjaro-md.md)] somente. |  
|PREEMPTIVE_AUDIT_ACCESS_SECLOG |Ocorre quando o agendador de Sistema operacional (SQLOS) alterna para o modo preemptivo para gravar um evento de auditoria para o log de segurança do Windows. <br /><br /> **Aplica-se a**: [!INCLUDE[ssKilimanjaro_md](../../includes/sskilimanjaro-md.md)] somente. |  
...
|PREEMPTIVE_HADR_LEASE_MECHANISM |Always On o agendamento do Gerenciador de concessão de grupos de disponibilidade para o diagnóstico de Suporte da Microsoft. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|PREEMPTIVE_HTTP_EVENT_WAIT |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|PREEMPTIVE_HTTP_REQUEST |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
...
|PREEMPTIVE_OS_GETFINALFILEPATHBYHANDLE |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
...
|PREEMPTIVE_OS_PDH_WMI_INIT |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|PREEMPTIVE_OS_PIPEOPS |Somente para uso interno.| 
|PREEMPTIVE_OS_PROCESSOPS |Somente para uso interno.| 
|PREEMPTIVE_OS_QUERYCONTEXTATTRIBUTES |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
...
|PREEMPTIVE_OS_SQMLAUNCH |Somente para uso interno. <br /><br /> **Aplica-se a**: do [!INCLUDE[ssKilimanjaro_md](../../includes/sskilimanjaro-md.md)] ao [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)]. |  
|PREEMPTIVE_OS_VERIFYSIGNATURE |Somente para uso interno.| 
|PREEMPTIVE_OS_VERIFYTRUST |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
...
|PREEMPTIVE_SOSTESTING |Identificado apenas para fins informativos. Não há suporte. A compatibilidade futura não está garantida.| 
|PREEMPTIVE_SP_SERVER_DIAGNOSTICS |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
...
|PREEMPTIVE_STRESSDRIVER |Identificado apenas para fins informativos. Não há suporte. A compatibilidade futura não está garantida.| 
|PREEMPTIVE_TESTING |Identificado apenas para fins informativos. Não há suporte. A compatibilidade futura não está garantida.| 
...
|PREEMPTIVE_XE_CX_FILE_OPEN |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] e posterior.| 
|PREEMPTIVE_XE_CX_HTTP_CALL |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] e posterior.| 
...
|PREEMPTIVE_XETESTING |Identificado apenas para fins informativos. Não há suporte. A compatibilidade futura não está garantida.| 
...
|PRU_ROLLBACK_DEFERRED |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|PWAIT_ALL_COMPONENTS_INITIALIZED |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|PWAIT_COOP_SCAN |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|PWAIT_DIRECTLOGCONSUMER_GETNEXT |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|PWAIT_EVENT_SESSION_INIT_MUTEX |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|PWAIT_FABRIC_REPLICA_CONTROLLER_DATA_LOSS |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|PWAIT_HADR_ACTION_COMPLETED |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|PWAIT_HADR_CHANGE_NOTIFIER_TERMINATION_SYNC |Ocorre quando uma tarefa em segundo plano está aguardando a conclusão de uma tarefa em segundo plano que recebe (via sondagem) as notificações do Windows Server Failover Clustering. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|PWAIT_HADR_CLUSTER_INTEGRATION |Uma operação de acréscimo, substituição e/ou remoção está aguardando para obter um bloqueio de gravação em uma Always On lista interna (como uma lista de redes, endereços de rede ou ouvintes de grupo de disponibilidade). Somente uso interno, <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|PWAIT_HADR_FAILOVER_COMPLETED |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|PWAIT_HADR_JOIN |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] e posterior.| 
|PWAIT_HADR_OFFLINE_COMPLETED |Uma operação Always On remover grupo de disponibilidade está aguardando o grupo de disponibilidade de destino ficar offline antes de destruir os objetos de clustering de failover do Windows Server. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|PWAIT_HADR_ONLINE_COMPLETED |Um Always On operação criar ou grupo de disponibilidade de failover está aguardando o grupo de disponibilidade de destino ficar online. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|PWAIT_HADR_POST_ONLINE_COMPLETED |Uma operação Always On remover grupo de disponibilidade está aguardando o encerramento de qualquer tarefa em segundo plano que foi agendada como parte de um comando anterior. Por exemplo, pode haver uma tarefa em segundo plano que está fazendo a transição de bancos de dados de disponibilidade para a função primária. O DROP AVAILABILITY GROUP DDL deve aguardar esta tarefa em segundo plano ser finalizada para evitar situações de competição. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|PWAIT_HADR_SERVER_READY_CONNECTIONS |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|PWAIT_HADR_WORKITEM_COMPLETED |Espera interna por um thread que espera uma tarefa de trabalho assíncrona ser concluída. Essa é uma espera prevista e deve ser usada pelo CSS. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|PWAIT_HADRSIM |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|PWAIT_LOG_CONSOLIDATION_IO |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] e posterior.| 
|PWAIT_LOG_CONSOLIDATION_POLL |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] e posterior.| 
|PWAIT_MD_LOGIN_STATS |Ocorre durante a sincronização interna nos metadados nas estatísticas de logon. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|PWAIT_MD_RELATION_CACHE |Ocorre durante a sincronização interna nos metadados na tabela ou no índice. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|PWAIT_MD_SERVER_CACHE |Ocorre durante a sincronização interna nos metadados em servidores vinculados. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|PWAIT_MD_UPGRADE_CONFIG |Ocorre durante a sincronização interna ao atualizar as configurações de servidor amplas. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|PWAIT_PREEMPTIVE_APP_USAGE_TIMER |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] e posterior.| 
|PWAIT_PREEMPTIVE_AUDIT_ACCESS_WINDOWSLOG |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|PWAIT_QRY_BPMEMORY |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|PWAIT_REPLICA_ONLINE_INIT_MUTEX |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|PWAIT_RESOURCE_SEMAPHORE_FT_PARALLEL_QUERY_SYNC |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|PWAIT_SBS_FILE_OPERATION |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] e posterior.| 
|PWAIT_XTP_FSSTORAGE_MAINTENANCE |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] e posterior.| 
|PWAIT_XTP_HOST_STORAGE_WAIT |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] e posterior.| 
|QDS_ASYNC_CHECK_CONSISTENCY_TASK |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] e posterior.| 
|QDS_ASYNC_PERSIST_TASK |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] e posterior.| 
|QDS_ASYNC_PERSIST_TASK_START |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] e posterior.| 
|QDS_ASYNC_QUEUE |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|QDS_BCKG_TASK |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] e posterior.| 
|QDS_BLOOM_FILTER |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|QDS_CLEANUP_STALE_QUERIES_TASK_MAIN_LOOP_SLEEP |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] e posterior.| 
|QDS_CTXS |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] e posterior.| 
|QDS_DB_DISK |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] e posterior.| 
|QDS_DYN_VECTOR |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] e posterior.| 
|QDS_EXCLUSIVE_ACCESS |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|QDS_HOST_INIT |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] e posterior.| 
|QDS_LOADDB |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] e posterior.| 
|QDS_PERSIST_TASK_MAIN_LOOP_SLEEP |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] e posterior.| 
|QDS_QDS_CAPTURE_INIT |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|QDS_SHUTDOWN_QUEUE |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] e posterior.| 
|QDS_STMT |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] e posterior.| 
|QDS_STMT_DISK |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] e posterior.| 
|QDS_TASK_SHUTDOWN |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] e posterior.| 
|QDS_TASK_START |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] e posterior.| 
|QE_WARN_LIST_SYNC |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] e posterior.| 
...
|QRY_PARALLEL_THREAD_MUTEX |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|QRY_PROFILE_LIST_MUTEX |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|QUERY_ERRHDL_SERVICE_DONE |Identificado apenas para fins informativos. Não há suporte. <br /><br /> **Aplica-se a**: [!INCLUDE[ssKilimanjaro_md](../../includes/sskilimanjaro-md.md)] somente. |  
|QUERY_WAIT_ERRHDL_SERVICE |Identificado apenas para fins informativos.  Não há suporte. <br /><br /> **Aplica-se a**: [!INCLUDE[ssKilimanjaro_md](../../includes/sskilimanjaro-md.md)] somente.  |  
...
|QUERY_NOTIFICATION_UNITTEST_MUTEX |Identificado apenas para fins informativos. Não há suporte. A compatibilidade futura não está garantida.| 
...
|QUERY_TASK_ENQUEUE_MUTEX |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|QUERY_TRACEOUT |Identificado apenas para fins informativos. Não há suporte. A compatibilidade futura não está garantida.| 
|RBIO_WAIT_VLF |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] e posterior.| 
|RBIO_RG_STORAGE |Ocorre quando um nó de computação de banco de dados de hiperescala está sendo limitado devido ao consumo de log atrasado no (s) servidor (es) de páginas. <br /><br /> **Aplica-se a**: hiperescala do banco de dados SQL do Azure.|
|RBIO_RG_DESTAGE |Ocorre quando um nó de computação de banco de dados de hiperescala está sendo limitado devido ao consumo de log atrasado pelo armazenamento de log de longo prazo. <br /><br /> **Aplica-se a**: hiperescala do banco de dados SQL do Azure.|
|RBIO_RG_REPLICA |Ocorre quando um nó de computação de banco de dados de hiperescala está sendo limitado devido ao consumo de log atrasado pelos nós de réplica secundária legíveis. <br /><br /> **Aplica-se a**: hiperescala do banco de dados SQL do Azure.|
|RBIO_RG_LOCALDESTAGE |Ocorre quando um nó de computação de banco de dados de hiperescala está sendo limitado devido ao consumo de log atrasado pelo serviço de log. <br /><br /> **Aplica-se a**: hiperescala do banco de dados SQL do Azure.|
|RECOVER_CHANGEDB |Ocorre durante a sincronização do status do banco de dados em espera passiva.| 
|RECOVERY_MGR_LOCK |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|REDO_THREAD_PENDING_WORK |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|REDO_THREAD_SYNC |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|REMOTE_BLOCK_IO |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] e posterior.| 
|REMOTE_DATA_ARCHIVE_MIGRATION_DMV |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|REMOTE_DATA_ARCHIVE_SCHEMA_DMV |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|REMOTE_DATA_ARCHIVE_SCHEMA_TASK_QUEUE |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
...
|REPL_TRANFSINFO_ACCESS |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|REPL_TRANHASHTABLE_ACCESS |Somente para uso interno.| 
|REPL_TRANTEXTINFO_ACCESS |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
...
|RESERVED_MEMORY_ALLOCATION_EXT |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|RESMGR_THROTTLED |Ocorre quando uma nova solicitação chega e é suprimida com base na configuração de GROUP_MAX_REQUESTS.| 
|RESOURCE_GOVERNOR_IDLE |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
...
|RESOURCE_SEMAPHORE_QUERY_COMPILE |Ocorre quando o número de compilações de consulta simultâneas atinge um limite de estrangulamento. Esperas e tempos de espera altos podem indicar compilações, recompilações ou planos não armazenáveis em cache excessivos.| 
|RESOURCE_SEMAPHORE_SMALL_QUERY |Ocorre quando uma solicitação de memória por meio de uma pequena consulta não pode ser concedida imediatamente devido a outras consultas simultâneas. O tempo de espera não deve exceder mais do que alguns segundos porque o servidor transfere a solicitação ao pool de memória de consulta principal se ele falhar ao conceder a memória solicitada dentro de alguns segundos. Esperas longas podem indicar número excessivo de pequenas consultas simultâneas enquanto o pool de memória principal está sendo bloqueado por consultas em espera. <br /><br /> **Aplica-se a**: [!INCLUDE[ssKilimanjaro_md](../../includes/sskilimanjaro-md.md)] somente. |  
|RESTORE_FILEHANDLECACHE_ENTRYLOCK |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|RESTORE_FILEHANDLECACHE_LOCK |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|RG_RECONFIG |Somente para uso interno.| 
|ROWGROUP_OP_STATS |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|ROWGROUP_VERSION |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|RTDATA_LIST |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] e posterior.| 
|SATELLITE_CARGO |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|SATELLITE_SERVICE_SETUP |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|SATELLITE_TASK |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|SBS_DISPATCH |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] e posterior.| 
|SBS_RECEIVE_TRANSPORT |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] e posterior.| 
|SBS_TRANSPORT |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] e posterior.| 
|SCAN_CHAR_HASH_ARRAY_INITIALIZATION |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
...
|SECURITY_CNG_PROVIDER_MUTEX |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] e posterior.| 
|SECURITY_CRYPTO_CONTEXT_MUTEX |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|SECURITY_DBE_STATE_MUTEX |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|SECURITY_KEYRING_RWLOCK |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
...
|SECURITY_RULETABLE_MUTEX |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|SEMPLAT_DSI_BUILD |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|SEQUENCE_GENERATION |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
...
|SERVER_RECONFIGURE |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|SESSION_WAIT_STATS_CHILDREN |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|SHARED_DELTASTORE_CREATION |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
...
|SLEEP_BUFFERPOOL_HELPLW |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
...
|SLEEP_MASTERDBREADY |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|SLEEP_MASTERMDREADY |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|SLEEP_MASTERUPGRADED |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|SLEEP_MEMORYPOOL_ALLOCATEPAGES |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|SLEEP_MSDBSTARTUP |Ocorre quando o SQL Trace aguarda o banco de dados msdb concluir a inicialização.| 
|SLEEP_RETRY_VIRTUALALLOC |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
...
|SLEEP_WORKSPACE_ALLOCATEPAGE |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|SLO_UPDATE |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] e posterior.| 
|SMSYNC |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|SNI_CONN_DUP |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] e posterior.| 
...
|SNI_WRITE_ASYNC |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] e posterior.| 
...
|SOCKETDUPLICATEQUEUE_CLEANUP |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
...
|SOS_LOCALALLOCATORLIST |Ocorre durante a sincronização interna no gerenciador de memória do [!INCLUDE[ssNoVersion_md](../../includes/ssnoversion-md.md)]. <br /><br /> **Aplica-se a**: [!INCLUDE[ssKilimanjaro_md](../../includes/sskilimanjaro-md.md)] somente. |  
|SOS_MEMORY_TOPLEVELBLOCKALLOCATOR |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
...
|SOS_PHYS_PAGE_CACHE |Contabiliza o tempo que um thread aguarda para obter o mutex necessário antes de alocar páginas físicas ou antes de retornar essas páginas para o sistema operacional. As esperas nesse tipo só aparecerão se a instância do [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] usar memória AWE. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|SOS_PROCESS_AFFINITY_MUTEX |Ocorre durante a sincronização de acesso para processar configurações de afinidade.| 
|SOS_RESERVEDMEMBLOCKLIST |Ocorre durante a sincronização interna no [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Gerenciador de memória. <br /><br /> **Aplica-se a**: [!INCLUDE[ssKilimanjaro_md](../../includes/sskilimanjaro-md.md)] somente. |  
...
|SP_PREEMPTIVE_SERVER_DIAGNOSTICS_SLEEP |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|SP_SERVER_DIAGNOSTICS_BUFFER_ACCESS |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|SP_SERVER_DIAGNOSTICS_INIT_MUTEX |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|SP_SERVER_DIAGNOSTICS_SLEEP |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
...
|SQLTRACE_BUFFER_FLUSH |Ocorre quando uma tarefa espera que, uma tarefa em segundo plano, libere buffers de rastreamento para o disco a cada quatro segundos. <br /><br /> **Aplica-se a**: [!INCLUDE[ssKilimanjaro_md](../../includes/sskilimanjaro-md.md)] somente. |  
|SQLTRACE_FILE_BUFFER |Ocorre durante sincronização em buffers de rastreamento durante um rastreamento de arquivo. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|SQLTRACE_FILE_READ_IO_COMPLETION |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|SQLTRACE_FILE_WRITE_IO_COMPLETION |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|SQLTRACE_INCREMENTAL_FLUSH_SLEEP |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|SQLTRACE_LOCK |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssKilimanjaro_md](../../includes/sskilimanjaro-md.md)] somente. |  
|SQLTRACE_PENDING_BUFFER_WRITERS |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
...
|STARTUP_DEPENDENCY_MANAGER |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|TDS_BANDWIDTH_STATE |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|TDS_INIT |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|TDS_PROXY_CONTAINER |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
...
|TEMPORAL_BACKGROUND_PROCEED_CLEANUP |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] e posterior.| 
|TERMINATE_LISTENER |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
...
|TRAN_MARKLATCH_NL |Identificado apenas para fins informativos. Não há suporte. A compatibilidade futura não está garantida.| 
...
|UCS_ENDPOINT_CHANGE |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|UCS_MANAGER |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|UCS_MEMORY_NOTIFICATION |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|UCS_SESSION_REGISTRATION |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|UCS_TRANSPORT |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|UCS_TRANSPORT_STREAM_CHANGE |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
...
|VDI_CLIENT_COMPLETECOMMAND |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] e posterior.| 
|VDI_CLIENT_GETCOMMAND |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] e posterior.| 
|VDI_CLIENT_OPERATION |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] e posterior.| 
|VDI_CLIENT_OTHER |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] e posterior.| 
|VERSIONING_COMMITTING |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
...
|WAIT_ON_SYNC_STATISTICS_REFRESH |Ocorre ao aguardar a conclusão da atualização de estatísticas síncrona antes da compilação da consulta e a execução ser retomada.<br /><br /> **Aplica-se ao**: A partir do [!INCLUDE[sql-server-2019](../../includes/sssqlv15-md.md)]|
|WAIT_SCRIPTDEPLOYMENT_REQUEST |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] e posterior.| 
|WAIT_SCRIPTDEPLOYMENT_WORKER |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] e posterior.| 
|WAIT_XLOGREAD_SIGNAL |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] e posterior.| 
|WAIT_XTP_ASYNC_TX_COMPLETION |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] e posterior.| 
|WAIT_XTP_CKPT_AGENT_WAKEUP |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] e posterior.| 
|WAIT_XTP_CKPT_CLOSE |Ocorre ao aguardar que um ponto de verificação seja concluído. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] e posterior.| 
|WAIT_XTP_CKPT_ENABLED |Ocorre quando o ponto de verificação é desabilitado, e espera o ponto de verificação ser habilitado. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] e posterior.| 
|WAIT_XTP_CKPT_STATE_LOCK |Ocorre durante a sincronização da verificação do estado do ponto de verificação. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] e posterior.| 
|WAIT_XTP_COMPILE_WAIT |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] e posterior.| 
|WAIT_XTP_GUEST |Ocorre quando o alocador de memória do banco de dados precisa parar de receber notificações de memória baixa. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|WAIT_XTP_HOST_WAIT |Ocorre quando as esperas são disparadas pelo mecanismo de banco de dados e implementadas pelo host. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] e posterior.| 
|WAIT_XTP_OFFLINE_CKPT_BEFORE_REDO |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] e posterior.| 
|WAIT_XTP_OFFLINE_CKPT_LOG_IO |Ocorre quando o ponto de verificação offline aguarda que uma leitura E/S de log seja concluída. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] e posterior.| 
|WAIT_XTP_OFFLINE_CKPT_NEW_LOG |Ocorre quando o ponto de verificação offline aguarda que novos registros de log sejam verificados. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] e posterior.| 
|WAIT_XTP_PROCEDURE_ENTRY |Ocorre quando um procedimento de descarte aguarda que todas as execuções atuais desse procedimento sejam concluídas. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] e posterior.| 
|WAIT_XTP_RECOVERY |Ocorre quando a recuperação de banco de dados está aguardando a conclusão da recuperação de objetos com otimização de memória. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] e posterior.| 
|WAIT_XTP_SERIAL_RECOVERY |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] e posterior.| 
|WAIT_XTP_SWITCH_TO_INACTIVE |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|WAIT_XTP_TASK_SHUTDOWN |Ocorre quando aguardar pela conclusão de um thread de OLTP na memória. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|WAIT_XTP_TRAN_DEPENDENCY |Ocorre ao aguardar dependências de transação. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] e posterior.| 
...
|WAITFOR_PER_QUEUE |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|WAITFOR_TASKSHUTDOWN |Identificado apenas para fins informativos. Não há suporte. A compatibilidade futura não está garantida.| 
...
|WCC |Identificado apenas para fins informativos. Não há suporte. A compatibilidade futura não está garantida.| 
|WINDOW_AGGREGATES_MULTIPASS |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|WINFAB_API_CALL |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] e posterior.| 
|WINFAB_REPLICA_BUILD_OPERATION |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] e posterior.| 
|WINFAB_REPORT_FAULT |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
...
|XDB_CONN_DUP_HASH |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|XDES_HISTORY |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|XDES_OUT_OF_ORDER_LIST |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|XDES_SNAPSHOT |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|XDESTSVERMGR |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
...
|XE_CALLBACK_LIST |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|XE_CX_FILE_READ |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] e posterior.| 
...
|XE_FILE_TARGET_TVF |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|XE_LIVE_TARGET_TVF |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.| 
|XE_MODULEMGR_SYNC |Identificado apenas para fins informativos. Não há suporte. A compatibilidade futura não está garantida.| 
|XE_OLS_LOCK |Identificado apenas para fins informativos. Não há suporte. A compatibilidade futura não está garantida.| 
|XE_PACKAGE_LOCK_BACKOFF |Identificado apenas para fins informativos. Não há suporte. <br /><br /> **Aplica-se a**: [!INCLUDE[ssKilimanjaro_md](../../includes/sskilimanjaro-md.md)] somente. |  
...
|XIO_CREDENTIAL_MGR_RWLOCK |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|XIO_CREDENTIAL_RWLOCK |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|XIO_EDS_MGR_RWLOCK |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] e posterior.| 
|XIO_EDS_RWLOCK |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] e posterior.| 
|XIO_IOSTATS_BLOBLIST_RWLOCK |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] e posterior.| 
|XIO_IOSTATS_FCBLIST_RWLOCK |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] e posterior.| 
|XIO_LEASE_RENEW_MGR_RWLOCK |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|XTP_HOST_DB_COLLECTION |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] e posterior.| 
|XTP_HOST_LOG_ACTIVITY |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] e posterior.| 
|XTP_HOST_PARALLEL_RECOVERY |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|XTP_PREEMPTIVE_TASK |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|XTP_TRUNCATION_LSN |Somente para uso interno. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL15_md](../../includes/sssql16-md.md)] e posterior.| 
|XTPPROC_CACHE_ACCESS |Ocorre quando acessa todos os objetos de cache de procedimento armazenado originalmente compilados. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] e posterior.| 
|XTPPROC_PARTITIONED_STACK_CREATE |Ocorre ao alocar estruturas de cache de procedimento armazenado compiladas originalmente por nó NUMA (deve ser feito em thread único) para um determinado procedimento. <br /><br /> **Aplica-se a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] e posterior.|
...
-   ddl_with_wait_at_low_priority  
 ...
 Para obter uma matriz de compatibilidade de bloqueio, confira [sys.dm_tran_locks &#40;&#41;Transact-SQL ](../../relational-databases/system-dynamic-management-views/sys-dm-tran-locks-transact-sql.md).  
  
## <a name="see-also"></a>Confira também  
    
 [SQL Server exibições de gerenciamento dinâmico relacionadas ao sistema operacional &#40;&#41;Transact-SQL ](../../relational-databases/system-dynamic-management-views/sql-server-operating-system-related-dynamic-management-views-transact-sql.md)   
 [&#41;&#40;Transact-SQL de sys.dm_exec_session_wait_stats ](../../relational-databases/system-dynamic-management-views/sys-dm-exec-session-wait-stats-transact-sql.md)   
