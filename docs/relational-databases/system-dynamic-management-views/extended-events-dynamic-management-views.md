---
description: Exibições de gerenciamento dinâmico de eventos estendidos
title: Exibições de gerenciamento dinâmico de eventos estendidos | Microsoft Docs
ms.custom: ''
ms.date: 03/15/2017
ms.prod: sql
ms.reviewer: ''
...
ms.locfileid: "98096594"
---
# <a name="extended-events-dynamic-management-views"></a>Exibições de gerenciamento dinâmico de eventos estendidos
[!INCLUDE [SQL Server](../../includes/applies-to-version/sqlserver.md)]

  Esta seção contém os seguintes objetos de gerenciamento dinâmico para Eventos Estendidos do [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].  
