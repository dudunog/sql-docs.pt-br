---
description: Geo-Replication exibições e funções de gerenciamento dinâmico (banco de dados SQL do Azure)
title: Geo-Replication exibições e funções de gerenciamento dinâmico (banco de dados SQL do Azure) | Microsoft Docs
ms.custom: ''
ms.date: 11/24/2015
ms.prod: sql
...
ms.locfileid: "98092956"
---
# <a name="geo-replication-dynamic-management-views-and-functions-azure-sql-database"></a>Geo-Replication exibições e funções de gerenciamento dinâmico (banco de dados SQL do Azure)
