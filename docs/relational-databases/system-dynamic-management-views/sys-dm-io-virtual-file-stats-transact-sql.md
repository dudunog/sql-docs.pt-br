...
ms.locfileid: "98151280"
---
# <a name="sysdm_io_virtual_file_stats-transact-sql"></a>sys.dm_io_virtual_file_stats (Transact-SQL)
[!INCLUDE [sql-asdb-asdbmi-asa-pdw](../../includes/applies-to-version/sql-asdb-asdbmi-asa.md)]

  Retorna estatísticas de E/S para arquivos de dados e de log. Essa função de gerenciamento dinâmico substitui a função [fn_virtualfilestats](../../relational-databases/system-functions/sys-fn-virtualfilestats-transact-sql.md) .  
...
**Aplica-se a:** Análise de Synapse do Azure
