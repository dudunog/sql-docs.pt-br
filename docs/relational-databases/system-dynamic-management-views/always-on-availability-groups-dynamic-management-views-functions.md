---
description: Exibições de gerenciamento dinâmico de grupos de disponibilidade Always On-funções
title: Always On exibições de gerenciamento dinâmico de grupos de disponibilidade – funções | Microsoft Docs
ms.custom: ''
ms.date: 03/16/2017
ms.prod: sql
ms.reviewer: ''
