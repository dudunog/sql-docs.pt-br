...
## <a name="sssql15-and-later"></a>[!INCLUDE[ssSQL15](../../includes/sssql16-md.md)] e posterior   
 A tabela a seguir descreve as colunas no `sys.dm_db_xtp_checkpoint_stats` , começando com **[!INCLUDE[ssSQL15](../../includes/sssql16-md.md)]** .  
