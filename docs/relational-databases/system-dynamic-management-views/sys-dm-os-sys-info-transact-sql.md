...
|**time_source_desc**|**nvarchar(60)**|**Aplica-se a:** [!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)] e posteriores.<br /><br /> Descreve a coluna **time_source** . Não permite valor nulo.<br /><br /> QUERY_PERFORMANCE_COUNTER = a API [QueryPerformanceCounter](/windows/win32/api/profileapi/nf-profileapi-queryperformancecounter) recupera o tempo do relógio de parede.<br /><br /> MULTIMEDIA_TIMER = a API de [timer de multimídia](/previous-versions//ms713418(v=vs.85)) que recupera o tempo do relógio de parede.|  
...
|**softnuma_configuration**|**int**|**Aplica-se a:** [!INCLUDE[ssSQL15](../../includes/sssql16-md.md)] e posteriores.<br /><br /> Especifica a maneira como os nós NUMA são configurados. Não permite valor nulo.<br /><br /> 0 = OFF indica o padrão de hardware<br /><br /> 1 = soft-NUMA automatizado<br /><br /> 2 = soft-NUMA manual via registro|  
|**softnuma_configuration_desc**|**nvarchar(60)**|**Aplica-se a:** [!INCLUDE[ssSQL15](../../includes/sssql16-md.md)] e posteriores.<br /><br /> OFF = o recurso soft-NUMA está desativado<br /><br /> ON = [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] determina automaticamente os tamanhos de nó numa para Soft-numa<br /><br /> MANUAL = soft-NUMA configurado manualmente|
...
|**socket_count** |**int** | **Aplica-se a:** [!INCLUDE[ssSQL15](../../includes/sssql16-md.md)] SP2 e posterior.<br /><br />Especifica o número de soquetes de processador disponíveis no sistema. |  
|**cores_per_socket** |**int** | **Aplica-se a:** [!INCLUDE[ssSQL15](../../includes/sssql16-md.md)] SP2 e posterior.<br /><br />Especifica o número de processadores por soquete disponível no sistema. |  
|**numa_node_count** |**int** | **Aplica-se a:** [!INCLUDE[ssSQL15](../../includes/sssql16-md.md)] SP2 e posterior.<br /><br />Especifica o número de nós numa disponíveis no sistema. Essa coluna inclui nós numa físicos, bem como nós numa soft. |  
