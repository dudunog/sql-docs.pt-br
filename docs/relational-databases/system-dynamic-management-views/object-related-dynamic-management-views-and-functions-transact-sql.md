---
description: Funções e exibições de gerenciamento dinâmico relacionadas ao objeto (Transact-SQL)
title: Exibições e funções de gerenciamento dinâmico relacionadas ao objeto (Transact-SQL) | Microsoft Docs
ms.custom: ''
ms.date: 02/10/2017
ms.prod: sql
ms.reviewer: ''
...
ms.locfileid: "98101641"
---
# <a name="object-related-dynamic-management-views-and-functions-transact-sql"></a>Funções e exibições de gerenciamento dinâmico relacionadas ao objeto (Transact-SQL)
[!INCLUDE [SQL Server](../../includes/applies-to-version/sqlserver.md)]

  Esta seção contém os objetos de gerenciamento dinâmico a seguir no [!INCLUDE[ssNoVersion_md](../../includes/ssnoversion-md.md)].  
