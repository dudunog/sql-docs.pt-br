---
description: Funções de rastreamento do sistema
title: Funções de rastreamento do sistema | Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "98092756"
---
# <a name="system-trace-functions"></a>Funções de rastreamento do sistema
[!INCLUDE [SQL Server](../../includes/applies-to-version/sqlserver.md)]

  O [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] fornece as funções de rastreamento de sistema a seguir.  
