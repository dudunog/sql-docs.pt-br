...
Ou, então, no [!INCLUDE[ssSQL15](../../includes/sssql16-md.md)] SP1 em diante, a [Dica de Consulta](../../t-sql/queries/hints-transact-sql-query.md#use_hint) `USE HINT ('FORCE_LEGACY_CARDINALITY_ESTIMATION')`.
