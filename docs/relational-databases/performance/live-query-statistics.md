...
description: Saiba como exibir o plano de execução em vigor de uma consulta ativa no SQL Server Management Studio. Use as estatísticas de execução para depurar problemas de desempenho da consulta.
ms.custom: ''
ms.date: 11/21/2018
ms.prod: sql
ms.reviewer: ''
...
> Esse recurso pode ser usado com o [Depurador Transact-SQL](../../ssms/scripting/configure-firewall-rules-before-running-the-tsql-debugger.md).  
