---
description: exibições do catálogo de tipos escalares (Transact-SQL)
title: Exibições de catálogo de tipos escalares (Transact-SQL) | Microsoft Docs
ms.custom: ''
ms.date: 03/15/2017
ms.prod: sql
...
ms.locfileid: "98095621"
---
# <a name="scalar-types-catalog-views-transact-sql"></a>exibições do catálogo de tipos escalares (Transact-SQL)
