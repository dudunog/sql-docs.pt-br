---
description: Exibições do catálogo de objeto (Transact-SQL)
title: Exibições do catálogo de objetos (Transact-SQL) | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2019
ms.prod: sql
...
ms.locfileid: "98092506"
---
# <a name="object-catalog-views-transact-sql"></a>Exibições do catálogo de objeto (Transact-SQL)

[!INCLUDE[sqlserver](../../includes/applies-to-version/sqlserver.md)]

Esta seção contém links para as exibições de catálogo a seguir.
...
## <a name="see-also"></a>Consulte Também  
 Exibições de [catálogo do sistema](catalog-views-transact-sql.md) exibições do [sistema &#40;Transact-SQL&#41;](../../t-sql/language-reference.md)  
