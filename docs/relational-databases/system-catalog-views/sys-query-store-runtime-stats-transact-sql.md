...
|**min_clr_time**|**bigint**|Tempo mínimo CLR para o plano de consulta dentro do intervalo de agregação (relatado em microssegundos).<br/>**Observação:** [!INCLUDE[ssSDW](../../includes/sssdw-md.md)] sempre retornará zero (0).|
