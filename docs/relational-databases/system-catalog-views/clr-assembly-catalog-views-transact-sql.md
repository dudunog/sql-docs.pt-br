---
description: Exibições do catálogo assembly CLR (Transact-SQL)
title: Exibições do catálogo do assembly CLR (Transact-SQL) | Microsoft Docs
ms.custom: ''
ms.date: 03/15/2017
ms.prod: sql
...
ms.locfileid: "98101835"
---
# <a name="clr-assembly-catalog-views-transact-sql"></a>Exibições do catálogo assembly CLR (Transact-SQL)
