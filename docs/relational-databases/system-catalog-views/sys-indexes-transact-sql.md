...
ms.openlocfilehash: a06c0570f55a46ae29d994f5eed8b34b95d72b39
ms.sourcegitcommit: a9e982e30e458866fcd64374e3458516182d604c
ms.translationtype: MT
ms.contentlocale: pt-BR
ms.lasthandoff: 01/11/2021
ms.locfileid: "98094546"
---
...
|**index_id**|**int**|ID do índice. **index_id** é exclusivo somente dentro do objeto.<br /><br /> 0 = Heap<br /><br /> 1 ou 5 = índice clusterizado (árvore B, columnstore)<br /><br /> > 1 e <> 5 = índice não clusterizado|  
...
## <a name="examples"></a>Exemplos  
 O exemplo a seguir retorna todos os índices para a tabela `Production.Product` no [!INCLUDE[ssSampleDBnormal](../../includes/sssampledbnormal-md.md)] banco de dados.  
