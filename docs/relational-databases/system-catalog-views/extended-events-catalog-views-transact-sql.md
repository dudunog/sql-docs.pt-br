---
description: exibições do catálogo de eventos estendidos (Transact-SQL)
title: Exibições do catálogo de eventos estendidos (Transact-SQL) | Microsoft Docs
ms.custom: ''
ms.date: 03/15/2017
ms.prod: sql
...
ms.locfileid: "98092616"
---
# <a name="extended-events-catalog-views-transact-sql"></a>exibições do catálogo de eventos estendidos (Transact-SQL)
[!INCLUDE[sqlserver](../../includes/applies-to-version/sqlserver.md)]

  Esta seção contém as exibições do catálogo a seguir para eventos estendidos do SQL Server.  
