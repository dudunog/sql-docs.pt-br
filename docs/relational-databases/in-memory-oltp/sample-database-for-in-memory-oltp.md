...
> [!NOTE]  
>  Para exibir este tópico para o [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)], consulte [Extensões do AdventureWorks para demonstrar o OLTP in-memory](./overview-and-usage-scenarios.md#in-memory-oltp-overview).  
