...
description: Saiba mais sobre o tamanho da tabela e da linha em tabelas com otimização de memória. Você pode criar uma tabela com várias colunas grandes e LOB.
ms.custom: ''
ms.date: 06/19/2017
ms.prod: sql
...
A tabela a seguir descreve o cálculo do tamanho do corpo da linha, fornecido como *tamanho do corpo da linha real* = SUM(*tamanho dos tipos superficiais*) + 2 + 2 * *número de colunas do tipo profundo*.  
