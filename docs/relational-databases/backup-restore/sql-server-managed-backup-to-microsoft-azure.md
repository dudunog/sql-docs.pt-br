...
description: O Backup Gerenciado do SQL Server para o Microsoft Azure gerencia e automatiza os backups do SQL Server para o Armazenamento de Blobs do Microsoft Azure.
ms.custom: ''
ms.date: 10/18/2016
ms.prod: sql
