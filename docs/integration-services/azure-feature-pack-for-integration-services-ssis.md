...
Isso deve ser feito por meio da [interface de instalação personalizada](/azure/data-factory/how-to-configure-azure-ssis-ir-custom-setup) para o Azure-SSIS Integration Runtime.
