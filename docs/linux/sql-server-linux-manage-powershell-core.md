...
- [Instalar o PowerShell Core no Windows](/powershell/scripting/install/installing-powershell-core-on-windows)
...
- [Instalar o PowerShell Core no ARM](/powershell/scripting/install/powershell-core-on-arm)
