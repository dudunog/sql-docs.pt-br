---
title: ^= atribuição de OR exclusivo bit a bit
description: Operação OR exclusiva bit a bit entre dois valores inteiros e define um valor como resultado da operação.
