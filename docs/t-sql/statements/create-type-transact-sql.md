...
### <a name="d-creating-a-user-defined-table-type-with-primary-key-and-index"></a>D. Como criar um tipo de tabela definido pelo usuário com o índice e a chave primária
