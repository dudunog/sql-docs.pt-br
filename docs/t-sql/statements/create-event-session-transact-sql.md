...
Para obter um exemplo de Banco de Dados SQL, confira o exemplo em [Código de destino do Arquivo de Evento para eventos estendidos no Banco de Dados SQL](/azure/sql-database/sql-database-xevent-code-event-file#transact-sql-code)
