 ...
 **AES**  
 Especifica que o ponto de extremidade deve usar o algoritmo AES. Esse é o padrão no [!INCLUDE[ssSQL15](../../includes/sssql16-md.md)] e posterior.  
