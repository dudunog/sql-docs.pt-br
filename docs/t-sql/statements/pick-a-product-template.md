...
description: Artigo de modelo para documentação de referência do Transact-SQL
ROBOTS: NOINDEX
ms.custom: ''
ms.date: 05/22/2019
ms.prod: sql
...
ms.openlocfilehash: a809afbe02a135a03d8257d2fd7c65b1d33e51fa
ms.sourcegitcommit: 370cab80fba17c15fb0bceed9f80cb099017e000
ms.translationtype: HT
ms.contentlocale: pt-BR
ms.lasthandoff: 12/17/2020
ms.locfileid: "97642352"
---
...
:::row:::
    ...
    :::column-end:::
    :::column:::
        [Banco de Dados SQL](pick-a-product-template.md?view=azuresqldb-current&preserve-view=true)
    :::column-end:::
    :::column:::
        [Instância Gerenciada de SQL](pick-a-product-template.md?view=azuresqldb-mi-current&preserve-view=true)
    :::column-end:::
    :::column:::
