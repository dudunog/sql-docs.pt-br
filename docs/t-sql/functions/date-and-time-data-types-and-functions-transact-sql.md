...
## <a name="date-and-time-data-types"></a><a name="DateandTimeDataTypes"></a> Tipos de dados de Data e Hora
...
### <a name="functions-that-modify-date-and-time-values"></a><a name="ModifyDateandTimeValues"></a> Funções que modificam valores de data e hora
...
### <a name="functions-that-set-or-return-session-format-functions"></a><a name="SetorGetSessionFormatFunctions"></a> Funções que definem ou retornam funções de formato da sessão
...
### <a name="functions-that-validate-date-and-time-values"></a><a name="ValidateDateandTimeValues"></a> Funções que validam valores de data e hora
...
## <a name="date-and-time-related-topics"></a><a name="DateandTimeRelatedTopics"></a> Tópicos relacionados à data e à hora

|Tópico|Descrição|
|-----------|-----------------|
|[FORMAT](../../t-sql/functions/format-transact-sql.md)|Retorna um valor formatado com o formato e a cultura opcional especificados. Use a função FORMAT para formatação com reconhecimento de localidade de valores de data/hora e número como cadeias de caracteres.|
