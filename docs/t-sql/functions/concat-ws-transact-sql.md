...
*separator* Uma expressão de qualquer tipo de caractere (`char`, `nchar`, `nvarchar` ou `varchar`).

*argument1, argument2, argumentN* Uma expressão de qualquer tipo. A função `CONCAT_WS` exige, pelo menos, dois argumentos e, no máximo, 254 argumentos.
