...
description: Referência de Transact-SQL para a função DATEADD. Essa função retorna uma data que foi modificada pela parte de data especificada.
ms.date: 07/29/2017
ms.prod: sql
