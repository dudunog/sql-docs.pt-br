...
## <a name="column-wise-parameter-binding"></a>Column-Wise Associação de parâmetro
...
## <a name="row-wise-parameter-binding"></a>Row-Wise Associação de parâmetro
...
### <a name="a-use-sqlbindparameter-function"></a>a. Usar a função SQLBindParameter
...
### <a name="b-execute-a-stored-procedure-using-a-named-parameter"></a>B. Executar um procedimento armazenado usando um parâmetro nomeado
