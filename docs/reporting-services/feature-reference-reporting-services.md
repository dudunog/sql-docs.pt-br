...
description: Saiba mais sobre as ferramentas e os aplicativos do SQL Server Reporting Services que podem ser usados para criar, gerenciar e exibir relatórios.
ms.date: 05/24/2018
