---
title: Função SUM (Construtor de Relatórios) | Microsoft Docs
description: A função Sum no Construtor de Relatórios retorna a soma de todos os valores numéricos não nulos especificados pela expressão.
ms.date: 03/07/2017
...
### <a name="a-sum-of-line-item-totals"></a>a. Soma dos totais de item de linha 
...
### <a name="b-maximum-value-from-all-nested-regions"></a>B. Valor máximo de todas as regiões aninhadas 
