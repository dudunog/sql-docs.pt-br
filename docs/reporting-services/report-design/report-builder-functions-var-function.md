---
title: Função Var (Construtor de Relatórios) | Microsoft Docs
description: Use a função Var para retornar a variância de todos os valores numéricos não nulos especificados pela expressão no Construtor de Relatórios.
ms.date: 03/07/2017
...
ms.locfileid: "98596709"
---
# <a name="report-builder-functions---var-function"></a>Funções do Construtor de Relatórios – Função Var
