...
description: Saiba mais sobre tabelas, matrizes, listas e regiões de dados tablix que exibem dados de relatório paginado organizados em linhas e colunas no Construtor de Relatórios.
ms.date: 03/14/2017
...
##  <a name="list"></a><a name="List"></a> Lista  
 ...
 Para obter mais informações, consulte [Criar faturas e formulários com listas](../../reporting-services/report-design/create-invoices-and-forms-with-lists-report-builder-and-ssrs.md).  
