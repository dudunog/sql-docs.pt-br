...
description: Use as informações fornecidas neste artigo sobre o tipo de conexão SAP NetWeaver BI para aprender a criar uma fonte de dados.
ms.date: 03/17/2017
...
-   No modo de Consulta, arraste dimensões, membros, propriedades de membros e imagens chave para o painel Consulta ou digite o texto MDX diretamente no painel Consulta. Arraste os membros calculados do painel Membros Calculados até o painel Dados para definir campos adicionais para o conjunto de dados.  
 ...
 Para obter mais informações sobre como trabalhar com esse designer de consulta, consulte [Interface do usuário do Designer de Consulta do SAP NetWeaver BI &#40;Construtor de Relatórios&#41;](/previous-versions/sql/).  
...
##  <a name="remarks"></a><a name="Remarks"></a> Comentários  
 ...
 Para obter mais informações, consulte [Usando o Reporting Services do SQL Server 2008 com o SAP NetWeaver Business Intelligence](/previous-versions/sql/sql-server-2008/cc974473(v=sql.100)).  
