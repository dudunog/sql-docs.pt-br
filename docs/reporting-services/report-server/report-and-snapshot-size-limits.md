...
description: Saiba mais sobre os limites de tamanho de relatório quando um relatório é publicado no Servidor de Relatório, renderizado em tempo de execução e salvo no sistema de arquivos.
ms.date: 03/14/2017
