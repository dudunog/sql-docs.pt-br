---
description: Uma lista de atualizações cumulativas e service packs mais recentes, com números de build do Microsoft SQL Server.
title: Últimas atualizações para o SQL Server
ms.date: 11/30/2020
ms.prod: sql
...
ms.locfileid: "98125617"
---
# <a name="latest-updates-for-microsoft-sql-server"></a>Atualizações mais recentes para o Microsoft SQL Server

[!INCLUDE [sqlserver](../../includes/applies-to-version/sqlserver.md)]

Este artigo lista as atualizações mais recentes dos produtos do SQL Server. Siga o [blog da versão do SQL Server](https://aka.ms/sqlreleases) para receber informações sobre atualizações e baixá-las.

Para saber mais sobre quais produtos têm suporte, confira a [Página de Ciclo de Vida do Produto da Microsoft](/lifecycle/products/?terms=sql).

## <a name="latest-updates"></a>Atualizações mais recentes

Cada um dos links a seguir fornece informações para todos os produtos e tecnologias aplicáveis.
...
|--|--|--|--|--|--|
|SQL Server 2019|N/D|[KB 4583458](https://support.microsoft.com/help/4583458)|CU 8 [(KB 4583459)](https://support.microsoft.com/help/4583459)|12/1/2021|[Instalação do SQL Server 2019](./install-sql-server.md)|
|Microsoft SQL Server 2017|N/D|[KB 4583456](https://support.microsoft.com/help/4583456)|CU 22 [(KB 4583457)](https://support.microsoft.com/help/4583457)|12/1/2021|[Instalação do SQL Server 2017](./install-sql-server.md)|
|SQL Server 2016|SP2 [(KB 4052908)](https://support.microsoft.com/help/4052908)|[KB 4583460](https://support.microsoft.com/help/4583460)|CU 15 [(KB 4583461)](https://support.microsoft.com/kb/4583461)|12/1/2021|[Instalação do SQL Server 2016](./install-sql-server.md)|
...
|SQL Server 2014|SP3 [(KB 4022619)](https://support.microsoft.com/kb/4022619)|[KB 4583463](https://support.microsoft.com/help/4583463)|CU 4 [(KB 4583462)](https://support.microsoft.com/kb/4583462)|12/1/2021|[Instalação do SQL Server 2014](https://www.microsoft.com/download/details.aspx?id=42299)|
...
|SQL Server 2012|SP4 [(KB 4018073)](https://support.microsoft.com/help/4018073/sql-server-2012-service-pack-4-release-information)  |[KB 4583465](https://support.microsoft.com/help/4583465)|N/D|N/D|[Instalação do SQL Server 2012](/previous-versions/sql/sql-server-2012/cc281837(v=sql.110))|
...
**Saiba como testar atualizações:** [Teste e desenvolvimento de roteiros de suporte para aplicativos ISV (PDF)](https://msdnshared.blob.core.windows.net/media/TNBlogsFS/prod.evol.blogs.technet.com/CommunityServer.Blogs.Components.WeblogFiles/00/00/00/85/48/Files/0827.Testing%20And%20Developing%20Supportability%20Roadmaps%20for%20ISV%20Applications.pdf)
...
- [Documentação do SQL Server](../../sql-server/index.yml)
...
- [Como determinar a versão, a edição e o nível de atualização do SQL Server e seus componentes](https://support.microsoft.com/help/321185/how-to-determine-the-version-edition-and-update-level-of-sql-server-an)
