...
> [!NOTE]
> Esta lista é idêntica à lista [!INCLUDE[sssql15-md](../includes/sssql16-md.md)]. Não há nenhum novo recurso preterido ou descontinuado do Mecanismo de Banco de Dados anunciado para o [!INCLUDE[sssqlv14-md](../includes/sssqlv14-md.md)].
