---
title: Exibir as propriedades da réplica de disponibilidade
description: Instruções para exibir as propriedades de uma réplica do grupo de disponibilidade do SSMS (SQL Server Management Studio), do Transact-SQL (T-SQL) ou do SQL PowerShell.
