...
description: Conheça o processo detalhado necessário para configurar a replicação do SQL Server com o grupo de disponibilidade Always On.
ms.custom: seodec18
ms.date: 01/25/2019
ms.prod: sql
ms.reviewer: ''
