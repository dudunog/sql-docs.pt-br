...
description: Descreve como exibir as propriedades de um ouvinte do grupo de disponibilidade Always On com o SQL Server Management Studio, o Transact-SQL ou o PowerShell no SQL Server.
