---
title: Iniciar a movimentação de dados em um banco de dados secundário
description: Saiba como iniciar a movimentação de dados para um banco de dados secundário que participa de um grupo de disponibilidade Always On no SQL Server.
