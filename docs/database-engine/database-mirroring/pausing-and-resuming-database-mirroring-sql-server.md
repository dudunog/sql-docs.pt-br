...
##  <a name="how-pausing-and-resuming-affect-log-truncation"></a><a name="EffectOnLogTrunc"></a> Como pausar e continuar afetam o truncamento de log  
