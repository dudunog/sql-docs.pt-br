...
description: Saiba mais sobre o espelhamento de banco de dados, que é uma solução para aumentar a disponibilidade de um banco de dados do SQL Server e é implementada por banco de dados.
ms.custom: ''
ms.date: 05/16/2016
ms.prod: sql
