---
description: Usar certificados para um ponto de extremidade de espelhamento de banco de dados (Transact-SQL)
title: Usar certificados para um ponto de extremidade de espelhamento de banco de dados
