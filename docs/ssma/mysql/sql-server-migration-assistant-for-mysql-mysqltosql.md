...
|Seção|Descrição|
|-----------|---------------|
|[Novidades no SSMA para MySQL](./what-s-new-in-ssma-for-mysql-mysqltosql.md)|O que há de novo nesta versão do SSMA para MySQL|  
...
|[Obtendo assistência do SSMA para MySQL](../sql-server-migration-assistant.md)|Fornece informações sobre como obter assistência adicional.|